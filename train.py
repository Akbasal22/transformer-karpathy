...
block_size = 128
batch_size = 64
vocab_size = tok.get_vocab_size() #200
n_embed = 96
dropout = 0.2
num_heads = 6
n_layers = 6
...
class Transformer(tf.keras.Model):
    ...
    def call(self, idx, targets = None):
        ...
        positions = tf.range(start=0, limit=T, dtype=tf.int32) 
    ...
    def generate(self, idx, max_new_tokens, temperature=1.0, top_k=None):
        ...
        for _ in range(max_new_tokens):
            ...
            logits = self.call(idx_cond)  # (B, T', vocab)
...
def main():
    ...
    history = model.fit(train_ds,
                    ...
                    epochs=10) 
    # model.save("model.h5")  # HDF5 format this h5 model appearently sucks, use .keras 
